...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "logs in with valid credentials and redirects to bookmarks" do
  ...
  test "unauthenticated users cannot reach bookmarks" do
    get bookmarks_path
    assert_redirected_to login_path
  end

  test "authenticated users can reach bookmarks" do
    post login_path, params: {
      email: @user.email,
      password: @password
    }
