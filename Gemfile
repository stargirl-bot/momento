...
# HTML parsing for the bookmark title fetcher (app/services/page_title_fetcher.rb)
gem "nokogiri"
...
group :development, :test do
  # Rails 8.0's test runner (Rails::LineFiltering#run) is incompatible with
  # minitest 6's Runnable#run signature, which errors out the whole suite.
  gem "minitest", "~> 5.25"
